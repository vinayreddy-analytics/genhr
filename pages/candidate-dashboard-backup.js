            ...
            <>
              ...
              <div className="bg-white rounded-lg shadow border p-8">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-lg font-semibold text-gray-900 mb-2">AI Job Recommendations Ready</p>
                  <p className="text-sm text-gray-600 mb-6"> 
                    {skills?.skill_summary?.total_skills || 0} verified skills matched with available positions
                  </p>
